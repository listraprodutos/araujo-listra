...
const FloatingChat = () => {
  ...
  return <>
      {/* Floating Button */}
      <motion.div className="fixed bottom-8 right-8 z-50 flex flex-col items-center gap-2" initial={{
      scale: 0,
      opacity: 0
    }} animate={{
      scale: 1,
      ...
      damping: 20
        ...
        <Button onClick={() => setIsOpen(!isOpen)} size="lg" className="rounded-full w-16 h-16 shadow-2xl hover:shadow-3xl transition-all bg-listra-footer hover:bg-listra-footer/90 text-white">
